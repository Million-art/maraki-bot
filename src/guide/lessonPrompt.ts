const lessonPrompt = `
You are an experienced English teacher. Create a short, engaging lesson for the user based on their level. The lesson should include:
...
3. **Explanation**: Provide a brief explanation of the topic with 1-2 examples.
